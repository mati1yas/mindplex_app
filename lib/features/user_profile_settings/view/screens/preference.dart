...
class _PreferencePageState extends State<PreferencePage> {
  ...
  Widget build(BuildContext context) {
      ...
      return Obx(() => preferenceController.isLoading.value?Scaffold(
              ...
              Column(
                children: <Widget>[
                            ...
                            children: [
                              Theme(
                                ...
                                child: Checkbox(
                                    ...
                                    value: preferenceController.darkMode.value,
                                    onChanged: (bool? newValue) {
                                      preferenceController.toogleColorTheme("dark", newValue!);
                                    }),
                              ),
                              SizedBox(
                                height: 5,
                            ...
                            children: [
                              Theme(
                                ...
                                child: Checkbox(
                                    activeColor: MaterialStateColor.resolveWith(
                                            (states) => Colors.pinkAccent),
                                    value: preferenceController.lightMode.value,
                                    onChanged: (bool? newValue) {
                                      preferenceController.toogleColorTheme("light", newValue!);
                                    }),
                              ),
                              SizedBox(
                                height: 5,
                        ...
                        children: [
                          Theme(
                            ...
                            child: Checkbox(
                                ...
                                onChanged: (bool? newValue) {
                                  preferenceController.toogleColorTheme("system", newValue!);
                                }),
                          ),
                          Padding(
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        labeledRadioButton("public", PrivacyPreference.public, 1),
                        labeledRadioButton("friends", PrivacyPreference.friends, 1),
                        labeledRadioButton("private", PrivacyPreference.private, 1)
                      ],
                    ),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        labeledRadioButton("public", PrivacyPreference.public, 2),
                        labeledRadioButton("friends", PrivacyPreference.friends, 2),
                        labeledRadioButton("private", PrivacyPreference.private, 2)
                      ],
                    ),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        labeledRadioButton("public", PrivacyPreference.public, 3),
                        labeledRadioButton("friends", PrivacyPreference.friends, 3),
                        labeledRadioButton("private", PrivacyPreference.private, 3)
                      ],
                    ),
                  ),
                  SizedBox(
                  ...
                  Center(
                    child: LabeledCheckbox(
                      ...
                      value: preferenceController.notifyPublications!.value,
                      onChanged: (bool newValue) {
                        preferenceController.notifyPublications!.value = newValue;
                      },
                    ),
                  ),
                  SizedBox(
                  ...
                  Center(
                    child: LabeledCheckbox(
                      ...
                      onChanged: (bool newValue) {
                        preferenceController.notifyEmail!.value = newValue;
                      },
                    ),
                  ),
                  SizedBox(
                  ...
                  Center(
                    child: LabeledCheckbox(
                      ...
                      padding: const EdgeInsets.symmetric(horizontal: 20.0),
                      value: preferenceController.notifyInteraction!.value,
                      onChanged: (bool newValue) {
                        preferenceController.notifyInteraction!.value= newValue;
                      },
                    ),
                  ),
                  SizedBox(
                  ...
                  Center(
                    child: LabeledCheckbox(
                      ...
                      onChanged: (bool newValue) {
                        setState(() {
                          preferenceController.notifyWeekly!.value= newValue;
                        });
                      },
                    ),
                  ),
                  ...
                  Center(
                    child: LabeledCheckbox(
                      ...
                      onChanged: (bool newValue) {
                        setState(() {
                          preferenceController.notifyUpdates!.value= newValue;
                        });
                      },
                    ),
                  ),
