...
class _RecommendationPageState extends State<RecommendationPage> {
  ...
  @override
  void initState() {
    recommendationController.fetchUserInfo(profileController.authenticatedUser.value.username!);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold(backgroundColor: mainBackgroundColor,body: Center(child: CircularProgressIndicator(),),):
    Scaffold(
          ...
          children: [
            ...
            Padding(
              ...
              child: Center(
                ...
                }),Color.fromARGB(255, 0, 207, 195),true),
              ),
            ),
          ],
        ),
