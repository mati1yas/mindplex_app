...
class ContributionController extends GetxController {
  List<Content> contents = [
    ...
    Content(
        type: "li",
        content:
            "Its ok to say words that appear bad if they're said in a friendly, bantering way."),
    Content(
        type: "li",
        content:
    ...
    Content(
        type: "li",
        content:
            "It's ok to say words that appear bad in a spirit of honest scientific enquiry, considering what might possibly be true."),
    Content(
        type: "li",
        content:
            "We reserve the right to take down harsh words spoken with hostility and an intent to hurt."),
    Content(type: "p", content: "Treat each other with respect and civility."),
    ...
    Content(
        type: "p",
        content:
            "We reserve the right to take down namecalling done in a spirit of hostility without a constructive goal. We will treat all sides equally in this."),
    Content(type: "h2", content: "Aim for Neutral, High-Quality Discussion"),
    Content(
        type: "p",
        content:
    ...
    Content(type: "h2", content: "Do Not Deliberately Create Hoaxes"),
    Content(type: "p", content: "This disrupts honest inquiry."),
    Content(
        type: "p",
        content:
    ...
    Content(type: "h2", content: "Resolving Disputes"),
    Content(
        type: "p",
        content:
    ...
    Content(type: "h2", content: "Emergency Takedowns"),
    Content(
        type: "p",
        content:
    ...
    Content(type: "h2", content: "How to Contribute"),
    Content(
        type: "p",
        content:
            "First, please create a user account on Mindplex. Then use the form below to send your content. You can publish an article, a podcast (Max. 40 minutes length), or a short video (Max. 25 minutes length). Keep them coming!"),
  ];
}
