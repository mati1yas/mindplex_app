...
bool _isUpdating = false;
  ...
  Widget build(BuildContext context) {
    ...
    child: Padding(
      ...
      child: Column(
      children: [
      _container(context, newPasswordController, "New Password", "new", newPasswordFocusNode, confirmPasswordFocusNode, null, () {
      setState(() {
      ...
      _container(
      context, confirmPasswordController, "Confirm Password", "confirm", confirmPasswordFocusNode, null, newPasswordController.text,
      () {
      setState(() {
    ...
    height: 48,
      ...
      child: ClipRRect(
        ...
        child: TextFormField(
          ...
          obscureText: type == "new" ? !_oldPasswordVisible : !_confirmPasswordVisible,
          style: type == "new"?_oldPasswordVisible?textTheme.displayMedium?.copyWith(fontSize: 15, fontWeight: FontWeight.w400,color: Colors.white):
          TextStyle(color: Colors.amber,fontSize: 30)://font size to be changed later on
          _confirmPasswordVisible?textTheme.displayMedium?.copyWith(fontSize: 15, fontWeight: FontWeight.w400,color: Colors.white):
          TextStyle(color: Colors.amber,fontSize: 30),//font size to be changed later on
          ...
          decoration: InputDecoration(
            ...
            contentPadding: type == "new"?_oldPasswordVisible?EdgeInsets.only(left: 10, top: 10, bottom: 10):EdgeInsets.only(left: 5,bottom: 5):_confirmPasswordVisible?EdgeInsets.only(left: 10, top: 10, bottom: 10):EdgeInsets.only(left: 5,bottom: 5),
